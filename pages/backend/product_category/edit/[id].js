...
const EditRole = ({query}) => {
  ...
  return (
    <>
      <Layout title="Edit Product Category" page_name="Product Category" sub_page="Edit" main_link="product_category">
